/*!
 * \file
 * \brief Startup and vector-table related code.
 * \author NXP
...
#ifndef PL_CONFIG_USE_ARES_BACKDOOR
  #define PL_CONFIG_USE_ARES_BACKDOOR (0)
#endif
#ifndef PL_CONFIG_USE_ARES_DISABLE_DEBUG
  #define PL_CONFIG_USE_ARES_DISABLE_DEBUG (0)
#endif
#ifndef PL_CONFIG_USE_ARES_HACKATHON
  #define PL_CONFIG_USE_ARES_HACKATHON (0)
#endif
#ifndef PL_CONFIG_DISABLE_NMI_EZPORT
  #define PL_CONFIG_DISABLE_NMI_EZPORT (0)
#endif

#if PL_CONFIG_USE_ARES_HACKATHON
  #define FLASH_CONFIG_ENABLE_FLASH_SECURITY  (1) /* 1: flash security enabled, 0: flash security disabled */
  #define FLASH_CONFIG_ENABLE_BACKDOOR        (1) /* application with backdoor access. Enables flash security! */
  #define FLASH_CONFIG_DISABLE_MASS_ERASE     (1) /* DO NOT ENABLE THIS IF YOU DON'T KNOW WHAT YOU ARE DOING!!!!!!! */
#else
  #define FLASH_CONFIG_ENABLE_FLASH_SECURITY  (0) /* 1: flash security enabled, 0: flash security disabled */
  #define FLASH_CONFIG_ENABLE_BACKDOOR        (PL_CONFIG_USE_ARES_BACKDOOR) /* application with backdoor access. Enables flash security! */
  #define FLASH_CONFIG_DISABLE_MASS_ERASE     (1 && PL_CONFIG_USE_ARES_BACKDOOR) /* DO NOT ENABLE THIS IF YOU DON'T KNOW WHAT YOU ARE DOING!!!!!!! */
#endif

#if FLASH_CONFIG_DISABLE_MASS_ERASE
  #warning "!!!DANGER ZONE!!!! Mass erase disabled. BE VERY CAREFUL!!!!!"
#endif

/* FLASH configuration at 0x400 */
__attribute__ ((used,section(".FlashConfig"))) const struct Flash_Config {
    unsigned int word1;
    unsigned int word2;
    unsigned int word3;
    unsigned int word4;
  ...
  /* default values */
    ...
    0xFFFFFFFE, /* FTFA_FSEC */
#else
  #if FLASH_CONFIG_ENABLE_BACKDOOR
    0x11111111, /* backdoor key */
    0x22222222, /* backdoor key */
  #else /* backdoor key disabled */
    0xFFFFFFFF, /* backdoor key */
    0xFFFFFFFF, /* backdoor key */
  #endif
    0xFFFFFFFF, /* NV Protection */
    ...
    0xFFFFFFFE
  #else
    /* FTFA_FSEC field, at address 0x40C */
    /* reserved (2 bytes): */
      ((0xffff)<<16)
    /* flash option register byte (FOPT), RM page 177: */
    | (0b11<<14)
    | (0b1<<13)      /* FAST_INIT: 0: slower initialization, 1: fast initialization */
    | (0b11<<11)     /* reserved */
  #if PL_CONFIG_DISABLE_NMI_EZPORT
    | (0b0<<10)      /* NMI: 0: disabled, 1: enabled */
    | (0b0<<9)       /* EZPORT: 0: disabled, 1: enabled */
  #else
    ...
    #if FLASH_CONFIG_ENABLE_BACKDOOR
    | (0b10<<6)     /* 10 backdoor key access enabled;  00,01,11: backdoor key address disabled (01 preferred) */
    #else /* backdoor key disabled */
    | (0b11<<6)     /* 10 backdoor key access enabled;  00,01,11: backdoor key address disabled (01 preferred) */
    #endif
    #if FLASH_CONFIG_DISABLE_MASS_ERASE /* !!!DANGER ZONE!!!! */
    | (0b10<<4)     /* 11,00,01: mass erase enabled, 10: mass erase disabled. BE VERY CAREFUL!!!!! */
    #else
    | (0b11<<4)     /* 11,00,01: mass erase enabled, 10: mass erase disabled. DO NOT CHANGE THIS!!!!! */
    #endif
    | (0b11<<2)     /* 11,00: factory access granted, 01,10 factory access denied */
    #if FLASH_CONFIG_ENABLE_FLASH_SECURITY || FLASH_CONFIG_ENABLE_BACKDOOR /* flash security enabled */
    | (0b11<<0)     /* 10: unsecure, 11,00,01: secure */
    #else /* flash security disabled */
...
void data_init(volatile unsigned int romstart, volatile unsigned int start, volatile unsigned int len) {
    volatile unsigned int *pulDest = (unsigned int*) start;
    volatile unsigned int *pulSrc = (unsigned int*) romstart;
...
static volatile int checker;
void Reset_Handler(void) {
    // Disable interrupts
    __asm volatile ("cpsid i");
   // while(checker!=0x12345678) {
   //   __asm volatile("nop");
   // }
    extern void _monDisable(void);
    //_monDisable();
#if PL_CONFIG_USE_ARES_DISABLE_DEBUG
//    void App_DisableDebugOnStartup(void);
//    App_DisableDebugOnStartup();
// Problem: memory gets erased afterwards!
#endif

#if 1 || defined (__USE_CMSIS)
// If __USE_CMSIS defined, then call CMSIS SystemInit code
    ...
    *((volatile unsigned short *)0x40052000) = 0x01D2u;
    ...
    //
    volatile unsigned int LoadAddr, ExeAddr, SectionLen;
    volatile unsigned int *SectionTableAddr;
